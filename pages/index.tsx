        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 py-20" ref={testimonialsRef}>
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="text-center animate-on-scroll">
              <Link href="/trainings">
                <span className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-lg text-base font-medium transition-all duration-200 hover-lift">
