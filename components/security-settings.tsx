        ...
        <div className="divide-y divide-gray-200">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="ml-4 btn-gradient-primary hover-gradient-lift px-4 py-2 text-sm"
              >
                Change Password
              </button>
            </div>
          ...
          <div className="p-6 bg-red-50 border-t border-red-200">
            <div className="flex items-center justify-between">
              ...
              <button className="ml-4 px-4 py-2 btn-gradient-danger hover-gradient-lift text-sm font-medium">
                Delete Account
              </button>
            </div>
          </div>
