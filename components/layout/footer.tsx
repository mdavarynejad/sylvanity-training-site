  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        {/* Main Footer Grid: 3 columns + 1 spanning column */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Left Side: 3x2 Grid */}
          <div className="md:col-span-3 md:border-r md:border-gray-700 md:pr-8">
            {/* Row 1: Company Info, Quick Links, Training Categories */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              {/* Company Info */}
              <div>
                <h3 className="text-xl font-bold mb-4">Sylvanity Training</h3>
            ...
            {/* Row 2: Our Publications spanning 3 columns */}
          ...
          {/* Right Side: Stay Updated spanning both rows */}
          <div className="md:row-span-2 md:pl-8">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Sylvanity Training. All rights reserved.
          </p>
